    ...
    <Layout>
      ...
      <div className={aboutStyle.darkstyle}>
        <div className={aboutStyle.inner}>
          <p>
            ...
            in 2013 with a focus on design. After finishing school I started
            with the bachelor studies in &raquo;
            <a
            ...
            <br />
            <br /> I got my first work experience in a Tec-Company in Berlin as
            project manager. In 2018 I started to work as a Websitebutler and
            Sitejet and gained a lot of experience in webdesign. Later, I
            continued my education in the field of web development. In the
            meantime, I started my master in &raquo;
            <a
            ...
            &laquo; at the HTW in Berlin. I expect to complete it in 2022.
          </p>
        </div>
        <div
      ...
      <div className={aboutStyle.section}>
        ...
        <p>
          ...
          experiences, targets and projects are summarized in the following
          pages.
        </p>
        ...
        <div className={aboutStyle.accordionOne}>
          ...
          <Accordion
            ...
            setActive={setActive}
            content={
              "In a team of four people we develop an app interface with the UX concept from »Contextual Design« by Karen Holtzblatt.\nOnce the concept has been established, the team starts work on it. The interface concept goes through various steps and optimisation loops. By critically questioning the usefulness of the app and the planned functions and features from step one, the final product will be user-friendly and not overloaded with functions, which makes it easy to use. The interface is tested and optimised again and again during the development process, e.g. through paper prototyping. \n \nA detailed blog post for this project is on schedule."
            }
          />
          <Accordion
            ...
            setActive={setActive}
            content={
              "The target is to increase my React & JacaScript knowledge to a high level. In the long run, I would like to work in the frontend. The next projects are in the app development area. In addition, a few Java-based projects will follow. This website should also develop continuously: multi language is planned & a darkmode will be implimented.\nAlso, more blog articles on my various projects will follow."
            }
          />
        </div>
      </div>
